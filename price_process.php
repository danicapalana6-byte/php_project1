...
if (isset($_POST['update_price'])) {
    ...
    if (empty($code) || empty($new_price) || empty($effective_date)) {
    ...
    $stmt = $conn->prepare("UPDATE inventory SET price = ?, price_updated = ? WHERE code = ?");
    $stmt->bind_param("dss", $new_price, $effective_date, $code);
